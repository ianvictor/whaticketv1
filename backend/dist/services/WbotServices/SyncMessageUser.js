...
const fetchMessageUser = ({ user, limit, ticketwhatsappId }) => __awaiter(void 0, void 0, void 0, function* () {
    const wbot2 = yield GetTicketWbot_1.default(ticketwhatsappId);
    const userChat = yield wbot2.getContactById(user + '@c.us')

    try {
        const chat = yield userChat.getChat();
        ...
        throw new AppError_1.default("ERR_SYNC_WAPP_MSG");
    }
});
exports.default = fetchMessageUser;
