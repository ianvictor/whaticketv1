...
const ChangeGroupTitle = ({ subject, ticketwhatsappId }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        wbot2.getChats().then(chats => {
            ...
            if (groups.length == 0) {
              ...
              groups.forEach((group, i) => {
                setTimeout(function() {
                    return group.setSubject(newSubject);
...
exports.default = ChangeGroupTitle;
