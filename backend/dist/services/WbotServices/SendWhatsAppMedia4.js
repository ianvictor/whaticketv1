...
const SendWhatsAppMedia2 = ({ number, url, ticketwhatsappId }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fileUrl = url;
    const media = yield MessageMedia.fromUrl(fileUrl);
    try {
        const sentMessage2 = yield wbot2.sendMessage(number, media, {sendAudioAsVoice: true});
