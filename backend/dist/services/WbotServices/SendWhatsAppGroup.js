...
const SendWhatsAppGroup= ({ newMessageGroup, ticketwhatsappId }) => __awaiter(void 0, void 0, void 0, function* () {
    const wbot2 = yield GetTicketWbot_1.default(ticketwhatsappId);
    try {
        let newMsgGroup = newMessageGroup;
        wbot2.getChats().then(chats => {
            ...
            if (groups.length == 0) {
              ...
              groups.forEach((group, i) => {
                setTimeout(function() {
                    return group.sendMessage(newMsgGroup);
...
exports.default = SendWhatsAppGroup;
