...
exports.remove = exports.update = exports.show = exports.store = exports.close = exports.index = void 0;
...
const SetAllTicketClosed_1 = __importDefault(require("../services/TicketServices/SetAllTicketClosed"));
...
const close = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const ticketClosed = yield SetAllTicketClosed_1.default();
    return res.status(200).json(ticketClosed);
});
exports.close = close;
    ...
    if (ticket.status === "closed") {
        ...
        if (farewellMessage) {
            yield SendWhatsAppMessage_1.default({
                body: Mustache_1.default(farewellMessage, ticket.contact),
                ticket
            });
        }
    }
